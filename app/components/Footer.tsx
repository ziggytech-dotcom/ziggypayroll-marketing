      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          <div className="col-span-2 md:col-span-1">
            <ZiggyPayrollLogo />
            <p className="mt-4 text-[#b3b3b3] text-sm leading-relaxed">Payroll for real small businesses</p>
          </div>
          <div>
            <h4 className="text-white font-semibold text-sm mb-4">Product</h4>
            <ul className="space-y-3">
              {['/features','/pricing','/integrations','/compare/gusto','/blog','/changelog','/security','/faq'].map((href) => (
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="https://twitter.com/ziggypayroll" target="_blank" rel="noopener noreferrer" className="text-[#b3b3b3] hover:text-white text-sm">Twitter / X</a></li>
              <li><a href="https://linkedin.com/company/ziggypayroll" target="_blank" rel="noopener noreferrer" className="text-[#b3b3b3] hover:text-white text-sm">LinkedIn</a></li>
              <li><a href="https://youtube.com/@ziggypayroll" target="_blank" rel="noopener noreferrer" className="text-[#b3b3b3] hover:text-white text-sm">YouTube</a></li>
            </ul>
          </div>
        </div>
