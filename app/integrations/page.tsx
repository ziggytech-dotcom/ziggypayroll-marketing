...
const nativeIntegrations = [
  { name: `Stripe`, domain: `stripe.com`, desc: `Sync revenue data and contractor payment reconciliation` },
  { name: `QuickBooks`, domain: `quickbooks.intuit.com`, desc: `Export payroll data directly to QuickBooks` },
  { name: `Zapier`, domain: `zapier.com`, desc: `Automate payroll workflows with 5,000+ apps` },
  { name: `Plaid`, domain: `plaid.com`, desc: `Secure bank account verification for direct deposit` },
  { name: `Slack`, domain: `slack.com`, desc: `Get payroll run confirmations and approval alerts` },
]
const comingSoon = [
  { name: `Xero`, domain: `xero.com`, desc: `Export payroll data to Xero accounting` },
  { name: `Gusto`, domain: `gusto.com`, desc: `Import existing contractor data from Gusto` },
  { name: `Rippling`, domain: `rippling.com`, desc: `Sync employee data with Rippling HR` },
]
const suiteApps = [
    ...
    <div className="bg-[#0a0a0a] min-h-screen" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
      ...
      <section className="relative overflow-hidden pt-20 pb-20 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">Works with the tools <span className="text-[#84cc16]">you already use</span></h1>
          <p className="text-xl text-[#b3b3b3] max-w-2xl mx-auto">ZiggyPayroll connects natively with your favorite tools — and via Zapier, with 5,000+ more.</p>
        </div>
      </section>
      <section className="py-16 px-4 border-b border-[#2d2d2d]">
        <div className="max-w-7xl mx-auto">
          <span className="px-2.5 py-1 rounded-full bg-[#84cc16]/10 border border-[#84cc16]/20 text-[#84cc16] text-xs font-medium">Native Suite</span>
      ...
      <section className="py-16 px-4 border-b border-[#2d2d2d]">
        <div className="max-w-7xl mx-auto">
          <span className="px-2.5 py-1 rounded-full bg-[#84cc16]/10 border border-[#84cc16]/20 text-[#84cc16] text-xs font-medium mb-6 inline-block">Native Integrations</span>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {nativeIntegrations.map((i) => (
              <div key={i.name} className="bg-[#111111] border border-[#1f1f1f] rounded-xl p-5 hover:border-[#84cc16]/30 transition-colors flex items-start gap-4">
                ...
                <div>
                  ...
                  <span className="inline-block mt-2 px-2 py-0.5 bg-[#84cc16]/10 text-[#84cc16] text-xs rounded-full">Native</span>
                </div>
              </div>
            ))}
          </div>
