...
export const metadata: Metadata = {
  title: "Changelog — ZiggyPayroll",
  description: "What's new in ZiggyPayroll. Feature updates, improvements, and release notes.",
}
    ...
    <>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1120, margin: "0 auto", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <a href="/" style={{ textDecoration: "none", fontSize: 22, fontWeight: 700, color: "#fff", letterSpacing: "-0.5px" }}>Ziggy<span style={{ color: ACCENT }}>Payroll</span></a>
          ...
          <a href="https://app.ziggypayroll.com/signup" style={{ background: ACCENT, color: "#fff", textDecoration: "none", padding: "9px 20px", borderRadius: 8, fontSize: 14, fontWeight: 700 }}>
            Start Free Trial
          </a>
        </div>
      </nav>
        ...
        <div style={{ position: "relative", paddingLeft: 32 }}>
          ...
          <div style={{ position: "relative", marginBottom: 64 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
              <span style={{ background: `rgba(132,204,22,0.15)`, color: ACCENT, border: `1px solid rgba(132,204,22,0.3)`, borderRadius: 99, padding: "4px 12px", fontSize: 12, fontWeight: 700, letterSpacing: "0.05em" }}>v1.0.0</span>
            ...
            <div style={{ background: "#111", border: "1px solid #1f1f1f", borderRadius: 16, padding: "28px 28px 24px" }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: "#fff", marginBottom: 16 }}>🚀 ZiggyPayroll is live</h3>
              <p style={{ fontSize: 14, color: "#666", marginBottom: 20, lineHeight: 1.6 }}>
                We've been building ZiggyPayroll for months. Today it's open for everyone. Here's everything you get on day one:
              </p>
              <ul style={{ listStyle: "disc", paddingLeft: 20, display: "flex", flexDirection: "column", gap: 6 }}>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Automated payroll processing with one-click run"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Direct deposit with same-day and next-day options"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Automated federal, state, and local tax filing"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Auto-generated W-2s and 1099s with e-filing"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Support for both W-2 employees and 1099 contractors"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Built-in time tracking and timesheet approvals"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Employee self-service portal for pay stubs and documents"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Multi-state payroll support"}</li>
              </ul>
            </div>
          </div>
