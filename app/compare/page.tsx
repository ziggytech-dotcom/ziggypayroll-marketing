...
export const metadata: Metadata = {
  title: "ZiggyPayroll vs Gusto vs ADP — Full Feature Comparison 2026",
  description:
    "How does ZiggyPayroll compare to Gusto and ADP? Side-by-side feature comparison, pricing breakdown, and why the ZiggyTech Business Suite changes everything.",
  keywords: [
  ...
  openGraph: {
    title: "ZiggyPayroll vs Gusto vs ADP — 2026 Comparison",
    description: "ZiggyPayroll at $29/mo vs Gusto at $46/mo + $6/person vs ADP at $79+/mo. Full feature comparison.",
    url: "https://ziggypayroll.com/compare",
  },
};
    ...
    <div style={{ background: bg, minHeight: "100vh", color: "#ffffff", fontFamily: "system-ui, sans-serif" }}>
      ...
      <section style={{ padding: "88px 24px 64px", textAlign: "center", borderBottom: `1px solid ${borderColor}` }}>
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          <h1 style={{ fontSize: "clamp(36px, 6vw, 56px)", fontWeight: 800, lineHeight: 1.1, marginBottom: "20px" }}>
            <span style={{ color: accent }}>ZiggyPayroll</span> vs Gusto vs ADP
          </h1>
          <p style={{ fontSize: "20px", color: muted, lineHeight: 1.6, marginBottom: "40px" }}>
            1099 contractor management made simple. See exactly how the tools compare — feature by feature, dollar by dollar.
          </p>
          <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="https://app.ziggypayroll.com/signup" style={{ background: accent, color: "#000", padding: "14px 28px", borderRadius: "10px", fontWeight: 700, fontSize: "16px", textDecoration: "none" }}>
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "20px" }}>
            ...
            <div style={{ background: cardBg, border: `1px solid ${borderColor}`, borderRadius: "16px", padding: "32px 24px", textAlign: "center" }}>
              ...
              <div style={{ fontSize: "42px", fontWeight: 800, color: "#ffffff", marginBottom: "4px" }}>$46/mo + $6/person</div>
            ...
            <div style={{ background: cardBg, border: `1px solid ${borderColor}`, borderRadius: "16px", padding: "32px 24px", textAlign: "center" }}>
              ...
              <div style={{ fontSize: "42px", fontWeight: 800, color: "#ffffff", marginBottom: "4px" }}>$79+/mo</div>
              <div style={{ fontSize: "14px", color: muted, marginBottom: "20px" }}>base plan</div>
              <div style={{ fontSize: "14px", color: muted }}>❌ No suite integration</div>
            </div>
          </div>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", background: cardBg, borderRadius: "16px", overflow: "hidden" }}>
              <thead>
                <tr style={{ borderBottom: `2px solid ${borderColor}` }}>
                  ...
                  <th style={{ padding: "16px", textAlign: "center", color: accent, fontSize: "13px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em" }}>ZiggyPayroll</th>
                  <th style={{ padding: "16px", textAlign: "center", color: muted, fontSize: "13px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em" }}>Gusto</th>
                  <th style={{ padding: "16px", textAlign: "center", color: muted, fontSize: "13px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em" }}>ADP</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  <tr style={{ borderBottom: "1px solid #1f1f1f" }}>
                    ...
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#a1a1aa", fontSize: "14px" }}>$46/mo + $6/person</td>
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#a1a1aa", fontSize: "14px" }}>$79+/mo (custom)</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid #1f1f1f" }}>
                    <td style={{ padding: "14px 16px", color: "#a1a1aa", fontSize: "15px" }}>1099 contractor management</td>
                  ...
                  <tr style={{ borderBottom: "1px solid #1f1f1f" }}>
                    <td style={{ padding: "14px 16px", color: "#a1a1aa", fontSize: "15px" }}>W-2 employee payroll</td>
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#ffffff", fontWeight: 600, fontSize: "15px" }}>✅</td>
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#a1a1aa", fontSize: "14px" }}>✅</td>
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#a1a1aa", fontSize: "14px" }}>✅</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid #1f1f1f" }}>
                    <td style={{ padding: "14px 16px", color: "#a1a1aa", fontSize: "15px" }}>Automatic tax filing</td>
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#ffffff", fontWeight: 600, fontSize: "15px" }}>✅</td>
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#a1a1aa", fontSize: "14px" }}>✅</td>
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#a1a1aa", fontSize: "14px" }}>✅</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid #1f1f1f" }}>
                    <td style={{ padding: "14px 16px", color: "#a1a1aa", fontSize: "15px" }}>Direct deposit</td>
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#ffffff", fontWeight: 600, fontSize: "15px" }}>✅</td>
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#a1a1aa", fontSize: "14px" }}>✅</td>
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#a1a1aa", fontSize: "14px" }}>✅</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid #1f1f1f" }}>
                    <td style={{ padding: "14px 16px", color: "#a1a1aa", fontSize: "15px" }}>Benefits administration</td>
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#ffffff", fontWeight: 600, fontSize: "15px" }}>✅ (basics)</td>
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#a1a1aa", fontSize: "14px" }}>✅ (extensive)</td>
                    <td style={{ padding: "14px 16px", textAlign: "center", color: "#a1a1aa", fontSize: "14px" }}>✅ (extensive)</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid #1f1f1f" }}>
                    <td style={{ padding: "14px 16px", color: "#a1a1aa", fontSize: "15px" }}>HR sync (ZiggyHR)</td>
      ...
      <section style={{ padding: "64px 24px", borderBottom: `1px solid ${borderColor}` }}>
        <div style={{ maxWidth: "760px", margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 style={{ fontSize: "36px", fontWeight: 700, marginBottom: "24px", lineHeight: 1.2 }}>
            Gusto and ADP are <span style={{ color: accent }}>standalone tools</span>.<br/>
            ZiggyPayroll is part of something bigger.
          </h2>
          <p style={{ fontSize: "18px", color: muted, lineHeight: 1.7, marginBottom: "40px" }}>
            ZiggyPayroll connects to ZiggyHR for headcount, ZiggyHQ for contractor records, and ZiggyInvoice for billing reconciliation — all automated.
          </p>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "16px", marginBottom: "40px" }}>
            {% for tool in ["ZiggyHQ", "ZiggyDocs", "ZiggySchedule", "ZiggyPayroll", "ZiggyPitch", "ZiggyHR", "ZiggyReviews", "ZiggyInvoice", "ZiggyIntake", "ZiggyNexus"] if tool != "ZiggyPayroll" %}
      ...
      <section style={{ padding: "80px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>
          ...
          <Link href="https://app.ziggypayroll.com/signup" style={{ background: accent, color: "#000", padding: "18px 40px", borderRadius: "12px", fontWeight: 700, fontSize: "18px", textDecoration: "none", display: "inline-block" }}>
            Try ZiggyPayroll Free →
          </Link>
        </div>
      </section>
